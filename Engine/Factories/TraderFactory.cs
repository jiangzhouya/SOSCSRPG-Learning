...
namespace Engine.Factories
{
    public static class TraderFactory
    {
        ...
        static TraderFactory()
        {
            ...
            Trader peterTheHerbalist = new Trader("Pete the Herbalist");
            peterTheHerbalist.AddItemToInventory(ItemFactory.CreateGameItem(1001));

            AddTraderToList(susan);
            AddTraderToList(farmerTed);
            AddTraderToList(peterTheHerbalist);               
